...
/*
* Read a string from keyboard and write it to a file
...
int main(int argc, char *argv[]) {
    ...
    */
    ...
    // 3 : CTL-C
    // 13 : ENTER
    for (c = getchar(); c != 3 && c !=13; c = getchar()) {
        if (c == EOF) {
        ...
        // — : 226 128 148
            ...
            // key coded in 3 chars
            else if (charsize == 3) {
                // if second char not set
                // we are reading the second char
                if (c1 == 0 ) { 
                    c1 = c;
                }
                // we are reading the last char
                else {
    ...
    if (c==3){
        ...
        printf("You typed ENTER. Exiting.\r\n");
    }
